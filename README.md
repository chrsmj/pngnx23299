...
```shell
wget https://github.com/chrsmj/pngnx23299/archive/refs/tags/v0.24.86-alpha.tar.gz
tar xzf v0.24.86-alpha.tar.gz
ansible-playbook --become-method=su -k -K -i TARGET, pngnx23299-0.24.86-alpha/playbook-alt.yml
```
